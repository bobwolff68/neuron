...
#sh distributeone.sh rwolff@192.168.46.84
...
#sh distributeone_cloud.sh ec2-user@50.18.52.35 ~/.ssh/xvd-demo.pem
sh distributeone_cloud.sh ec2-user@122.248.248.19 ~/.ssh/xvd-demo.pem
