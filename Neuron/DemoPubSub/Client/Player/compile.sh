...
gcc main.c decode.c display.c thread_shared_data.c ../x264_vfr_module/x264_vfr_module.c ../x264_vfr_module/x264_buffer_parser.c -g3 -o xvdplay -L$NDDSHOME/lib/i86Linux2.6gcc4.1.1 -m32 -DRTI_UNIX -DRTI_LINUX -lavformat -lavcodec -lswscale -lavutil -lNeuronVideoPubSub -ldl -lnddsc -lnddscpp -lnddscore `sdl-config --cflags --libs` `pkg-config --cflags --libs gtk+-2.0`
